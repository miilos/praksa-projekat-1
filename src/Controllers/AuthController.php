...
class AuthController
{
    public function signup($data): void
    {
        ...
        // SessionController nije controller vise je SessionManager
    ...
    private function createUser($data): array
    {
        ...
        // CODE_REVIEW COMMENT: Komunikaciju sa bazom cuvaj u modelu
        try {
...
//            }
            ...
            ErrorController::redirectToErrorPage('something-went-wrong');
        }
